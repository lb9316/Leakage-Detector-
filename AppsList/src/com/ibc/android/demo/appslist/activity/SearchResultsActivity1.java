...
public class SearchResultsActivity1 extends Activity  implements OnItemClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) 
    {
        ...
        setContentView(R.layout.activity_search_results1);
    ...
    {
    	String query="";
    	apkList1 = (ListView) findViewById(R.id.applist_search1);;
